...
public class Cliente extends javax.swing.JFrame {
    ...
    private ClienteModel montaCliente(){
        ClienteModel c = new ClienteModel();
        c.setAtividade(jcbAtividade.getSelectedItem().equals("Ativo"));
        c.setCpf(jftfCpf.getText());
        c.setData_nascimento(jftfDataNasc.getText());
        c.setNome_completo(jtfNome.getText());
        c.setPontos(Integer.parseInt(jtfPontos.getText()));
        c.setTelefone(Integer.parseInt(jftfTelefone.getText()));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jlCpf)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jftfCpf, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void jbCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCadastrarActionPerformed
        ClienteModel cliente = this.montaCliente();
        ClienteDAO clienteDAO = new ClienteDAO();
